        ...
        <div class="col-xs-10">
            ...
            <div class = "col-xs-12" id="contendio">
                ...
                <div id = "panelVista" class="col-xs-10 col-xs-offset-1" style = "margin-bottom: 100px;background-color: #fff; padding: 20px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-default" onclick="editarEmpleado('<%=i.getCedula()%>')" id="editar_<%=i.getCedula()%>">V</button>
                                </td>
                            </tr>
                            <%
                                }
                    ...
                    <div class = "col-xs-12">
                        <center><button class=" btn btn-info" onclick="agregarEmpleado()">Agregar Empleado</button></center> 
                    </div>
                </div>
                ...
                <div id = "panelEdicion"  class="col-xs-10 col-xs-offset-1" style="visibility: hidden;">
                    ...
                    <div class="col-xs-12" style="border-left: 1px solid #eee;">
                        <br>
                        <br>
                        <form class = "col-xs-12" action="empleadosCRUD_registrar.htm" method="post">
                            ...
                            <div class="form-group frm col-xs-12">
                                <div class="col-xs-3">
                                    <label class="control-label col-xs-3">Hoja de vida</label>
                                </div>
                                <div class="col-xs-9">
